...
function Signup() {
  ...
  const toggleTheme = () => {
    loginthememode === false
      ? setloginThememode(true)
      : setloginThememode(false);
  };
        ...
        <Box sx={{ display: "flex", flexDirection: "column" }}>
          <Box sx={{ display: "flex", justifyContent: "center" }}>
            <img
              ...
              alt="Peershala"
              style={{
                filter: loginthememode ? "invert(100%)" : "",
                fontSize: "1rem",
                height: "5rem",
                width: "70%",
              }}
          ...
          >
            ...
            >
              ...
              <TextField
                sx={{
                  "& input": { color: loginthememode ? "white" : "black" },
                }}
                color="secondary"
                id="outlined-basic"
                label="First name"
            ...
            <TextField
              sx={{ "& input": { color: loginthememode ? "white" : "black" } }}
              color="secondary"
              id="outlined-basic"
              label="college name"
              variant="outlined"
          ...
          >
            <ColorButton
              ...
              startIcon={success ? <CheckCircleIcon /> : ""}
            >
          ...
          <Divider
            sx={{ color: loginthememode ? "#afafaf" : "#43464a", marginY: 2 }}
          >
